    ...
    module.exports = {
        ...
        _bindUI:function(){
            ...
            $("#search").focus(function(){
                $(".hc_sil").hide(200);
                $(".s_btn").css(
                    "background","url(./images/topsearch-icon2_8c8d8b0.png) center center no-repeat #35b558"
                );
            }).blur(function(){
                $(".hc_sil").show(200);
                $(".s_btn").css(
                    "background","url(./images/topsearch-icon_e1f5df2.png) center center no-repeat"
                );
            });
